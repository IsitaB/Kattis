...
Input
Input starts with two integers 1<=N,P<=1000 on a single line, denoting the number 
of contestants in the contest and the number of huffle-puff problems solved in 
total. Then follow N lines, each consisting of a single non-empty line in which 
the contestant describes him or herself. You may assume that the contestants 
are good at describing themselves
...
public class SolvingForCarrots
{
   public static void main(String[] args)
   {
    ...
    int contestants = console.nextInt();
    int problems = console.nextInt();
    String descriptions = "";
    
    for(int i = 0; i <= contestants; i++)
    {
        descriptions += console.nextLine();
    }
    //num of carrots = num of problems solved
